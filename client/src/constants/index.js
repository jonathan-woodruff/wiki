...
export const SERVER_URL = isProduction ? 'https://api.peacehens.com' : 'http://localhost:8000'; //https://wiki-web-service.onrender.com
export const CLIENT_URL = isProduction ? 'https://www.peacehens.com' : 'http://localhost:8080'; //https://www.wiki-client.onrender.com
